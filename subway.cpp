...
void First_Search(char firstList[]);
...
int main()
{
    ...
    while (ptr)
    {
        if (ptr->change != 0)
        {
            ...
            else if (size == 2 && strcmp(ptr->list, "Euljiro3-ga") == 0)
            {
                plusTemp = ptr;
            ...
            else if (size == 3 && strcmp(ptr->list, "DongdaemunHistory&CulturePark") == 0)
            {
                plusTemp = ptr;
            ...
            else if (size == 4 && strcmp(ptr->list, "Daerim") == 0)
            {
                plusTemp = ptr;
...
void First_Search(char firstList[])
{
    ...
    while (ptr)
    {
        ...
        //        tfTemp2 = ptr;
        //        trans = false;
        //        //searchCount도 잠시 템프로 받아줘야 하나
        //        while (ptr)
        //        {//20220118 여기서 change가 1일 경우와 9일 경우를 판단해서 갈 수 있는가? 계속 무한루프가 된다.
        ...
        //                ptr = ptr->way[4];*/
        //            trans = true;
        //            first_Search(firstList); //여기서 다시 함수를 콜할 경우 다시 다음 것이 9여서 돌아온다.
        //            if (strcmp(ptr->list, firstList) == 0 || searchCount >= 50)
        //                return;
        //        }
        //        if (strcmp(ptr->list, firstList) == 0 || searchCount >= 50)
